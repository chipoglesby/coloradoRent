...
```{r echo = FALSE}
files <- as.data.frame(paste("[",list.files(path="../analysis", pattern="*.md", full.names=T, recursive=FALSE), "](", list.files(path="../analysis", pattern="*.md", full.names=T, recursive=FALSE),")", "", sep = ""))
colnames(files) = c("Reports")
